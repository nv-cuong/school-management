            ...
            <div class="container-fluid">
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6" style="text-align: right;">
                        <a href="{{ route('admin.assign_subject.create') }}" class="btn btn-success"><i
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-2">
                                            ...
                                            <select class="form-control" name="status">
                                                ...
                                                <option {{ Request::get('status') == 1 ? 'selected' : '' }} value="1">
                                                    Active</option>
                                                <option {{ Request::get('status') == 2 ? 'selected' : '' }} value="2">
                                                    Inactive</option>
                                            </select>
                                        </div>
                                        {{-- <div class="form-group col-md-2">
                                        ...
                                        <div class="form-group col-md-3">
                                            ...
                                            <input type="date" class="form-control"
                                                value="{{ Request::get('date_start') }}" name="date_start"
                                                placeholder="Enter start date">
                                        </div>
                                        <div class="form-group col-md-3">
                                            <label>End date</label>
                                            <input type="date" class="form-control"
                                                value="{{ Request::get('date_end') }}" name="date_end"
                                                placeholder="Enter end date">
                                        </div>
                                    </div>
                                    <div class="row d-flex justify-content-center">
                                        <button type="submit" class="btn btn-info mr-5 button-100"><i
                                                class="fas fa-search mr-1"></i>Search</button>
                                        <a class="btn btn-secondary button-100"
                                            href="{{ route('admin.assign_subject.index') }}"><i
                                    ...
                                    <tbody>
                                        @foreach ($listAS as $list)
                                            <tr>
                                                ...
                                                <td>{{ $list->user_name }}</td>
                                                <td>{{ date('d/m/Y h:i:s A', strtotime($list->updated_at)) }}</td>
                                                <td>
                                                    <a class="btn btn-primary"
                                                        href="{{ route('admin.assign_subject.edit', $list->id) }}"
                                                        title="Edit"><i class="fas fa-edit"></i></a>
                                                    <a class="btn btn-primary"
                                                        href="{{ route('admin.assign_subject.edit_single', $list->id) }}"
                                                        title="Edit">Edit single</a>
                                                    <a class="btn btn-danger"
                                                        href="{{ route('admin.assign_subject.delete', $list->id) }}"
